...
export const Cup = {
    ...
    price: 200,
    endDate:"2023-04-15T00:00:00.000Z",
    path:'kawaii_skeleton_cat_cup.glb',
    rotation: [0.4, 1, 0],
    position: [0, 0, 0],
    scale:[1,1,1],
    normalSize:{
...
export const Island = {
    ...
    price: 200,
    endDate:"2023-04-15T00:00:00.000Z",
    path:'low_poly_medieval_island.glb',
    rotation: [0.5, 0, 0],
    position: [0, 0, 0],
    scale:[1,1,1],
    normalSize:{
